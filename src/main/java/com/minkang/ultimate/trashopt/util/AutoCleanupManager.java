...
public class AutoCleanupManager {
    ...
    public void startFromConfig() {
        ...
        long intervalMinutes = plugin.getConfig().getLong("cleanup.auto.interval_minutes", 10);
        ...
        final boolean checkConditions = plugin.getConfig().getBoolean("cleanup.auto.check_conditions", false);
        ...
        final List<Integer> announceFinal = (announce == null || announce.isEmpty())
                ? java.util.Arrays.asList(30,10,5,4,3,2,1)
