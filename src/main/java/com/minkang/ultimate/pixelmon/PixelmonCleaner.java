...
public class PixelmonCleaner {
    public static int cleanNonLegendary(Main plugin, World w) {
        ...
        for (Entity e : w.getEntities()) {
            ...
            if (!com.minkang.ultimate.pixelmon.PixelmonUtil.isPixelmon(plugin, e)) continue;
            if (skipLeg && com.minkang.ultimate.pixelmon.PixelmonUtil.isLegendary(plugin, e)) continue;
