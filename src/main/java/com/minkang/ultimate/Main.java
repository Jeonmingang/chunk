...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        // Core services
        this.tpsMonitor = new TpsMonitor(this); this.tpsMonitor.start();
        this.conditionGuard = new ConditionGuard(this);
        this.autoCleanupManager = new AutoCleanupManager(this); this.autoCleanupManager.initFromConfig();
        this.wbAutomation = new WorldBorderAutomationManager(this); this.wbAutomation.initFromConfig();
